...
image = pygame.image.load('mm.png')
image2 = pygame.image.load('right.png')
image1 = pygame.image.load('left-hand.png')
image = pygame.transform.scale( image, (800, 600))
image1 = pygame.transform.scale( image1, (300, 150))
image2 = pygame.transform.scale( image2, (300, 150))
while not done:
